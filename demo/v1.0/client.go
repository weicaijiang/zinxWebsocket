...
func main() {
	...
	for {
		...
		log.Println(string(recvMsg.GetData()))
		...
		case 20:
			...
			log.Println(room)
		case 30:
			log.Println("recv server:", string(recvMsg.GetData()))
		case 40:
			log.Println("recv server:", string(recvMsg.GetData()))
		default:
			log.Println("error msgid:", recvMsg.GetMsgId())
		}
...
func timeWriter(conn *websocket.Conn) {
	...
	for {
		...
		// 	break
		// }
		// sendMsg = znet.NewMessage(2, websocket.BinaryMessage, jsonData)
		// encryMsg, err = dp.Pack(sendMsg)
		// if err != nil {
		// 	log.Println("client timeWriter pack err:", err, " msg:", msg)
		// 	break
		// }
		// conn.WriteMessage(websocket.BinaryMessage, encryMsg)

		// //第三个是回写数据
		// repeatMsg := []byte("第三个包repeat message i = " + strconv.Itoa(i))
		// sendMsg = znet.NewMessage(3, websocket.TextMessage, repeatMsg)
		// encryMsg, err = dp.Pack(sendMsg)
		// if err != nil {
		// 	log.Println("client timeWriter pack err:", err, " msg:", msg)
		// 	break
